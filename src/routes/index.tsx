          ...
          <div className="md:col-span-8 space-y-10">
            ...
            <div className="grid sm:grid-cols-3 gap-px bg-border">
              {[
                ...
                { n: "III", t: "Production", d: "You use the language in real scenarios — meetings, emails, presentations — while we refine your pronunciation, tone, delivery and more, so your communication feels confident and natural." },
              ].map((s) => (

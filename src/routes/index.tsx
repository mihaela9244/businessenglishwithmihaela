      ...
      <section className="relative overflow-hidden">
        <div className="mx-auto max-w-6xl px-6 md:px-10 pt-12 pb-20 md:pt-20 md:pb-32 grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-6">
            <a href="https://students.nacid.bg/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full bg-amber-400 text-yellow-950 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest hover:bg-amber-300 transition-colors" title="ЕАН: DH17434 · ЕНД: 43801ZZ">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
              Diploma Certified · ЕАН DH17434 / ЕНД 43801ZZ
            </a>
            ...
            <p className="mt-8 max-w-xl text-lg text-muted-foreground leading-relaxed">
              One‑to‑one tutoring for professionals, with lessons tailored to your needs and goals so you can grow at your own pace.
            </p>
          ...
          <div className="md:col-span-6 relative flex flex-col md:flex-row gap-4">
            <div className="relative flex-[3] aspect-video overflow-hidden rounded-sm shadow-2xl bg-muted">
              <video
                src={videoAsset.url}
            ...
            <div className="relative flex-[1.2] aspect-[3/4] overflow-hidden rounded-sm shadow-2xl bg-muted max-w-[240px]">
              <img
